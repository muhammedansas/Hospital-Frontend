...
const UserList = () => {
    ...
    {users.map(user =>(
       ...
       <form ref={editRef} onClick={Blockuser()} className="space-y-4 md:space-y-6" action="#">
           <button type="submit" style={{width:"80px",borderRadius:"5px",height:"30px",border:"0px",backgroundColor:'green',color:"white",fontWeight:"bold"}} >Unblock</button>
        </form>
            <button  style={{width:"70px",borderRadius:"5px",height:"30px",border:"0px",backgroundColor:'#eb1919',color:"white",fontWeight:"bold"}} >Block</button>
           </div>
      </div>
    ))} 
